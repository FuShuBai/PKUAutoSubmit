...
if __name__ == '__main__':
    ...
    parser.add_argument('--campus', type=str, help='所在校区, 燕园、万柳、畅春园、圆明园、中关新园、医学部', default='医学部')
    parser.add_argument('--reason', type=str, help='出校原因, eg. 吃饭', default='进学校上课')
    parser.add_argument('--destination', type=str, help='出校目的地, eg. 北京', default='北京')
    parser.add_argument('--track', type=str, help='出校轨迹, eg. 畅春园食堂', default='医学部-燕园-医学部')
    ...
    parser.add_argument('--street', type=str, help='入校前居住所在街道, eg. 燕园街道', default='学院路街道')
